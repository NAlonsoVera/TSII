...
var dialog = renderer.create('<div class="modal fade" role="dialog" tabindex="-1"/>', function ($node, options) {
    $node.html([
        ...
        (options.title
            ? '    <div class="modal-header">' +
                ...
                '    </div>' : ''),
        '    <div class="modal-body row">' + options.body + '</div>',
        (options.footer
...
var LinkDialog = /** @class */ (function () {
    ...
    LinkDialog.prototype.initialize = function () {
        ...
        var body = [
            '<div class="form-group note-form-group col-sm-12">',
            ...
            !this.options.disableLinkTarget
                ? '<div class="col-sm-12">' + $$1('<div/>').append(this.ui.checkbox({
        ...
        this.$dialog = this.ui.dialog({
            ...
            body: body,
            footer: footer
        }).render().appendTo($container); //$container
    };
...
var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
        ...
        var body = [
            '<div class="form-group note-form-group note-group-select-from-files col-sm-12">',
            '<label class="note-form-label">' + this.lang.image.selectFromFiles + '</label>',
            '<input class="note-image-input note-form-control note-input" ',
            ' type="file" name="files" accept="image/*" multiple="multiple" />',
            imageLimitation,
            '</div>',
            '<div class="form-group note-group-image-url col-sm-12" style="overflow:auto;">',
...
var VideoDialog = /** @class */ (function () {
    ...
    VideoDialog.prototype.initialize = function () {
        var $container = this.options.dialogsInBody ? this.$body : this.$editor;
        var body = [
            '<div class="form-group note-form-group row-fluid col-sm-12">',
