$(function(){function u(){if(t.length===1){let i=mpolLocalStorage("mpol_carritotemporal").get();i&&i.length!==0?($("#table-cart").removeClass("hidden"),$("#vacio-carrito").hasClass("hidden")||$("#vacio-carrito").addClass("hidden"),$.ajax({url:"/Producto/ListadoFiltro",data:{productos:i},type:"POST",success:function(r){if(r){t.html("");n=r;let u=r.map(n=>n.cCodigoUno).join();fetch(`/Producto/ConsultaStock?codigoInterno=${u}`).then(n=>n.json()).then(n=>{$.each(r,function(r,u){if(i.some(n=>n.pk_eProducto==u.pk_eProducto)){let r=i.find(n=>n.pk_eProducto==u.pk_eProducto),f={};f=Array.isArray(n)?n.find(n=>u.cCodigoUno==n.codigoDeArticulo):n;t.append(`
                                        <div class="content-tr" data-identify="${u.pk_eProducto}" data-server="false">
                                            <div class="row">
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 vertical-center-table">
                                                    <ul>
                                                        ...
                                                        <li class="name-product">
                                                            ...
                                                            <p class="stock-actual" style="font-size: 11px;display:none" data-stock-actual="${f.stock}">Stock actual : ${f.stock}</p>
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4 vertical-center-table text-center hidden">
                                                    ...
                                                    <p class="text-price" data-precio-final="${u.dPrecioVentaFinal}">${u.cPrecioVentaFinal} 
                                                    <br>
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 vertical-center-table text-center">
                                                     <div class=" bottom-vertical price-total-cart" style="float: right;">
                                                        <p class="text-total" data-sub-total="${u.dPrecioVentaFinal*r.eCantidad}">S/${agregarCommaMillions((u.dPrecioVentaFinal*r.eCantidad).toFixed(2))}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        `)}})})}},complete:function(){r()}})):($("#table-cart").addClass("hidden"),$("#vacio-carrito").removeClass("hidden"),$(".cart-no").text("0"))}}function f(){t.length===1&&$.ajax({url:"/ShoppingCart/ListadoProductosEnCarrito",type:"GET",success:function(i){if(i.length>0){$("#table-cart").removeClass("hidden");$("#vacio-carrito").hasClass("hidden")||$("#vacio-carrito").addClass("hidden");t.html("");n=i;let r=i.map(n=>n.cCodigoUno).join();fetch(`/Producto/ConsultaStock?codigoInterno=${r}`).then(n=>n.json()).then(n=>{$.each(i,function(i,r){let u={};u=Array.isArray(n)?n.find(n=>r.cCodigoUno==n.codigoDeArticulo):n;t.append(`
                                    <div class="content-tr" data-identify="${r.fk_eProducto}" data-server="true">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-5 col-xs-5 vertical-center-table-text">
                                                ...
                                                <p class="marca">${r.cMarca!=null?r.cMarca:r.cTipoProducto}</p>
                                                <span><a href="javascript:void(0)" style="color:red;" class="btnEliminar">Eliminar</a></span>
                                            </div>
                                             <div class="col-lg-3 col-md-2 col-sm-2 col-xs-2 vertical-center-table text-center input-cant">
                                                <div class=" bottom-vertical">
