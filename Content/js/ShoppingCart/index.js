                        ...
                        success: function (data) {
                            if (data) {
                                $.ajax({
                                    ...
                                    data: {
                                        pk_eProducto: parseInt($this.parents(".content-tr").attr("data-identify")),
                                        eCantidad: valorcant
                                    },
                                    type: "POST",
    ...
    $("#listProductInCart").on("click", ".btnEliminar", function () {
        ...
        else
        {
            ...
            $.each($localCarrito, function (i, e) {
                ...
                if (e.pk_eProducto == parseInt(identify)) {
                    mpolLocalStorage("mpol_carritotemporal").delete(i);
                    $parent.remove();
                    mpolRefreshItem(false);
                    $productosFiltrados = $productosFiltrados.filter(x => x.pk_eProducto != parseInt(identify));
                    MostrarProductosDeCarrito();
                    ActualizarDatosSinLogeo();
                    $(".loading").hide();
                }
                                    ...
                                    $.each(productos, function (i2, e2) {
                                        ...
                                        <div class="content-tr" data-identify="${e2.pk_eProducto}" data-server="false">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-5 col-xs-5 vertical-center-table-text">
                                                ...
                                                <div class="col-lg-3 col-md-2 col-sm-2 col-xs-2 vertical-center-table text-center input-cant">
                                                     <div class=" bottom-vertical">
                                                        <div class="item__quantity">
                                                            <div class="item__quantity__input item__quantity__input__plus">
                                                                ...
                                                                <input type="number" class="form-control pr-0 iptCantidad" id="iptCantProducto" value="${e.eCantidad}" readonly>
                                                                <button class="fa fa-plus addCantProduct" type="button"></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4 vertical-center-table text-center hidden">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 vertical-center-table text-center">
                                                     <div class=" bottom-vertical price-total-cart" style="float: right;">
                                ...
                                $.each(productos, function (i2, e2) {
                                    ...
                                    <div class="content-tr" data-identify="${e2.fk_eProducto}" data-server="true">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 vertical-center-table text-center">
                                                <div class="bottom-vertical price-total-cart" style="float: right;">
                                                    <p class="text-total" data-sub-total="${(e2.dPrecioVentaFinal * e2.eCantidad)}">S/${agregarCommaMillions((e2.dPrecioVentaFinal * e2.eCantidad).toFixed(2))}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
